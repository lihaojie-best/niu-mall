...
@ApiModel(value = "UmsIntegrationChangeHistoryPo对象", description = "积分变化历史记录表")
public class UmsIntegrationChangeHistoryPo extends Model<UmsIntegrationChangeHistoryPo> {
