...
public class UmsAdminController {
     ...
     * @return com.niu.mall.common.api.Result<UmsAdminPo>
     * @author lihaojie
     ...
     * @param pageNum 当前页
     * @param pageSize 页面大小
     * @return com.niu.mall.common.api.Result<com.niu.mall.common.api.CommonPage<UmsAdminPo>>
     * @author lihaojie
     * @date 2022/12/30 23:18
     */
     ...
     *
     * @param adminId 用户id
     * @return com.niu.mall.common.api.Result<java.util.List<UmsRolePo>>
     * @author lihaojie
