...
import com.niu.mall.admin.dao.PmsProductCategoryDao;
...
public class PmsProductCategoryServiceImpl extends ServiceImpl<PmsProductCategoryDao, PmsProductCategoryPo> implements PmsProductCategoryService {
     ...
     * @param pageNum  当前分页
     * @param pageSize 分页大小
     * @return java.util.List<com.niu.mall.mbg.po.PmsProductCategoryPo>
     * @author lihaojie
     ...
     * 查询所有一级分类及子分类
     *
     * @return java.util.List<com.niu.mall.admin.dto.PmsProductCategoryWithChildrenDto>
     * @author lihaojie
