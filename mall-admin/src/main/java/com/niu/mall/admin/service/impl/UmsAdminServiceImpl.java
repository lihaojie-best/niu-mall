...
import com.niu.mall.admin.bo.AdminUserDetailsBo;
...
public class UmsAdminServiceImpl extends ServiceImpl<UmsAdminDao, UmsAdminPo> implements UmsAdminService {
    ...
    public List<UmsAdminPo> list(String keyword, Integer pageSize, Integer pageNum) {
        ...
        QueryWrapper<UmsAdminPo> whereWrapper =new QueryWrapper<UmsAdminPo>().like("username",keyword).or().like("nick_name",keyword);
        return this.list(whereWrapper);
    }
    /**
     * 更新用户信息
     *
