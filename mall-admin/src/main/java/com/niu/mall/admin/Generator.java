...
public class Generator {
    public static void main(String[] args) {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/niumall?useSSL=false&useUnicode=true&characterEncoding=utf-8&useLegacyDatetimeCode=false&serverTimezone=Asia/Shanghai");
        ...
        globalConfig.setOutputDir("D:/cood/niu-mall/mall-admin/src/main/java");
        //  \\src\\main\\java
        //设置完之后是否打开资源管理器   NO
